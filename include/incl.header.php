...
<script
	src="/<?=explode('/', $_SERVER['REQUEST_URI'])[1]?>/js/jquery.js"></script>

<!-- Include all compiled plugins (below), or include individual files as needed -->
<script
	src="/<?=explode('/', $_SERVER['REQUEST_URI'])[1]?>/js/bootstrap.min.js"></script>

<title>PayPal Demo Portal</title>

<!--Including Bootstrap style files-->
<link
	href="/<?=explode('/', $_SERVER['REQUEST_URI'])[1]?>/css/bootstrap.min.css"
	rel="stylesheet">
	...
	<div class="container-fluid">
		...
		<div class="well bg-color">
			<h2 class="text-center">
				Express Checkout via Braintree SDK - <a
					href="/<?=explode('/', $_SERVER['REQUEST_URI'])[1]?>/index.php#readme"
					class="light-links">Readme</a>
			</h2>
		</div>
